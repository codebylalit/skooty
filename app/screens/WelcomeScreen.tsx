...
export default function WelcomeScreen({ navigation }: WelcomeScreenProps) {
  ...
  return (
    ...
    >
      ...
      {/* Bottom options as links (optional) */}
      <View style={{ position: 'absolute', bottom: 32, left: 0, right: 0, flexDirection: 'row', justifyContent: 'center' }}>
        <TouchableOpacity onPress={() => navigation.navigate('DriverLogin')} style={{ marginRight: 32 }}>
          <Text style={{ fontSize: 13, color: Colors.light.secondary + '99', textDecorationLine: 'underline', fontFamily: 'Inter' }}>Become a Driver</Text>
        </TouchableOpacity>
        {/* <TouchableOpacity onPress={() => navigation.navigate('AdminLogin')}>
          <Text style={{ fontSize: 13, color: Colors.light.secondary + '99', textDecorationLine: 'underline', fontFamily: 'Inter' }}>Admin Login</Text>
        </TouchableOpacity> */}
      </View>
    </KeyboardAvoidingView>
  );
