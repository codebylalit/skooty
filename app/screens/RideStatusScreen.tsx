...
export default function RideStatusScreen({ navigation }) {
  ...
  const advanceStatus = async () => {
    ...
    try {
      ...
      if (nextIndex === STATUS_FLOW.length - 1) {
        Alert.alert('Ride Completed', 'Your ride is completed!');
      }
    } catch (e) {
  ...
  if (!ride) {
    return <View style={tw`flex-1 justify-center items-center bg-white`}><Text>No active ride found.</Text></View>;
  }
